...
<head lang="en">
    <meta charset="UTF-8">
    <title>兼职信息</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/statics/css/newjob.css"/>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/jquery-1.12.4.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/newjob.js"></script>
</head>
<body>
<div class="header">
...
<div class="middle">
    <div class="middle0">
        <input class="fb" type="button" id="publish" value="兼职发布"/><input class="fb" id="mypublish" type="button" value="我的发布"/>
    ...
    <div class="middle1">
        ...
        <p class="pcount">共<span id="totalCount">${pageSupport.totalCount}</span>个兼职信息</p>
    ...
    <div class="middle2">
        <ul class="uul">
            ...
            <c:forEach var="Job" items="${pageSupport.list}">
                <li><a class="cona" href="joblook.do?id=${Job.id}">${Job.title}</a><span class="spanftr">${Job.schoolName}</span><span class="spanftr">${Job.userName}</span><span class="spantime">${Job.date}</span><span class="spancount">${Job.sum}</span></li>
            </c:forEach>
        </ul>
    </div>
    <div class="page">
