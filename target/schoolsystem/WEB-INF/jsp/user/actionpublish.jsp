...
<head lang="en">
    <meta charset="UTF-8">
    <title>最新活动发布</title>
    <link href="${pageContext.request.contextPath}/statics/css/actionpublish.css" rel="stylesheet"/>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery-1.12.4.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/actionpublish.js"></script>
</head>
<body>
<div class="header">
...
<div class="middle">
    ...
    <div class="middle1">
        <form action="actionpublish.do" method="post" enctype="multipart/form-data">
...
<c:if test="${not empty actionPublishSuccess}">
    <script type="text/javascript">
        alert("${actionPublishSuccess}");
