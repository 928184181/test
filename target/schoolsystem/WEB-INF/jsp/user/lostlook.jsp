...
<head lang="en">
    <meta charset="UTF-8">
    <title>查看遗失物品</title>
    <link href="${pageContext.request.contextPath}/statics/css/lostlook.css" rel="stylesheet"/>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery-1.12.4.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/lostlook.js"></script>
</head>
<body>
<div class="header">
...
<div class="middle">
    ...
    <div class="middle1">
        <p><span class="span1">标题</span><input class="inp" value="${myLostLook.title}" type="text" readonly/></p>
        <p><span class="span1">描述</span></p>
        <textarea class="text" readonly>${myLostLook.content}</textarea>
        <p><span class="span1">发布时间</span><input class="inp2" type="text" value="${myLostLook.date}" readonly/><span class="span3">地点</span><input class="inp2" type="text" value="${myLostLook.address}"  readonly/><span class="span4">是否已认领</span><input class="inp2" type="text" value="${myLostLook.claimName}"  readonly/></p>
        <div class="middle2">
            <img class="imgs" src="${pageContext.request.contextPath}/statics/lost/${myLostLook.pictureName}"/>
        </div>
    </div>
</div>
<div class="footer">
