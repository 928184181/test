...
<head lang="en">
    <meta charset="UTF-8">
    <title>后台管理系统--二手商品审核</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/statics/css/backgoods.css"/>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/jquery-1.12.4.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/backgoods.js"></script>
</head>
<body>
<div class="header">
...
<div class="middle">
    <div class="middle0">
        <input class="fb" type="button" id="all" value="所有商品"/><input class="fb" id="audit" type="button" value="待审核"/>
    </div>
    <div class="middle1">
        ...
        <p class="pcount">共<span id="totalCount">${pageSupport.totalCount}</span>个二手商品</p>
    ...
    <div class="middle2">
        <ul class="uul">
            ...
            <c:forEach var="goods" items="${pageSupport.list}">
                <li><a class="cona" href="${pageContext.request.contextPath}/backgoodslook.do?id=${goods.id}&pageIndex=${pageSupport.currentPage}">${goods.title}</a><span class="spanftr">${goods.statusName}</span><span class="spantime">${goods.date}</span><a class="spancount" href="${pageContext.request.contextPath}/backgoodslook.do?id=${goods.id}&pageIndex=${pageSupport.currentPage}">查看</a><a class="spancount1" href="" onclick="del(${goods.id})">删除</a></li>
            </c:forEach>
        </ul>
    </div>
    <div class="page">
