...
<head lang="en">
    <meta charset="UTF-8">
    <title>失物招领查看</title>
    <link href="${pageContext.request.contextPath }/statics/css/backlostlook.css" rel="stylesheet"/>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/jquery-1.12.4.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/backlostlook.js"></script>
</head>
<body>
<div class="header">
...
<input type="hidden" id="lostId" value="${backlost.id}"/>
<div class="header2">
...
<div class="middle">
    ...
    <div class="middle1">
        <p><span class="span1">标题</span><input class="inp" type="text" value="${backlost.title}" readonly/></p>
        <p><span class="span1">内容</span></p>
        <textarea class="text" readonly>${backlost.content}</textarea>
        <div class="middle2">
            <c:if test="${not empty backlost.pictureName}">
                <img class="imgs" src="${pageContext.request.contextPath }/statics/lost/${backlost.pictureName}">
            </c:if>
        </div>
        <p><span class="span1">发布时间</span><input class="inp2" type="text" value="${backlost.date}" readonly/><span class="span3">发布人</span><input class="inp2" type="text" value="${backlost.userName}" readonly/></p>
        <p><span class="span2">发布人电话</span><input class="inp2" type="text" value="${backlost.phone}" readonly/></p>
        <p><span class="span2">发布人QQ</span><input class="inp2" type="text" value="${backlost.qq}" readonly/></p>
        <p><span class="span2">发布人微信</span><input class="inp2" type="text" value="${backlost.weixin}" readonly/></p>
    </div>
    <div class="audit">
