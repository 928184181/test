...
<head lang="en">
    <meta charset="UTF-8">
    <title>查看帖子</title>
    <link href="${pageContext.request.contextPath}/statics/css/mynewslook.css" rel="stylesheet"/>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/jquery-1.12.4.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/statics/js/mynewslook.js"></script>
</head>
<body>
<div class="header">
