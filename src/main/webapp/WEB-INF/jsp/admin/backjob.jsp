...
<head lang="en">
    <meta charset="UTF-8">
    <title>后台管理系统--兼职信息审核</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/statics/css/backjob.css"/>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/jquery-1.12.4.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/backjob.js"></script>
</head>
<body>
<div class="header">
...
<div class="middle">
    <div class="middle0">
        <input class="fb" type="button" id="all" value="所有兼职"/><input class="fb" id="audit" type="button" value="待审核"/>
    </div>
    <div class="middle1">
    ...
    <div class="middle2">
        <ul class="uul">
            ...
            <c:forEach var="job" items="${pageSupport.list}">
                <li><a class="cona" href="${pageContext.request.contextPath}/backjoblook.do?id=${job.id}&pageIndex=${pageSupport.currentPage}">${job.title}</a><span class="spanftr">${job.statusName}</span><span class="spantime">${job.date}</span><a class="spancount" href="${pageContext.request.contextPath}/backjoblook.do?id=${job.id}&pageIndex=${pageSupport.currentPage}">查看</a><a class="spancount1" href="" onclick="del(${job.id})">删除</a></li>
            </c:forEach>
        </ul>
    </div>
    <div class="page">
