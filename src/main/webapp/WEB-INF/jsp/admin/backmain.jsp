...
<head lang="en">
    <meta charset="UTF-8">
    <title>后台管理系统--最新活动审核</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/statics/css/backmain.css"/>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/jquery-1.12.4.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/backmain.js"></script>
</head>
<body>
<div class="header">
...
<div class="middle">
    <div class="middle0">
        <input class="fb" type="button" id="all" value="所有活动"/><input class="fb" id="audit" type="button" value="待审核"/>
    </div>
    <div class="middle1">
        ...
        <p class="pcount">共<span id="totalCount">${pageSupportAdmin.totalCount}</span>个最新活动</p>
    ...
    <div class="middle2">
        <ul class="uul">
            ...
            <c:forEach var="newAction" items="${pageSupportAdmin.list}">
            <li><a class="cona" href="${pageContext.request.contextPath}/adminactionlook.do?id=${newAction.id}&pageIndex=${pageSupportAdmin.currentPage}">${newAction.title}</a><span class="spanftr">${newAction.statusName}</span><span class="spantime">${newAction.date   }</span><a class="spancount" href="${pageContext.request.contextPath}/adminactionlook.do?id=${newAction.id}&pageIndex=${pageSupportAdmin.currentPage}">查看</a><a class="spancount1" href="" onclick="del(${newAction.id})">删除</a></li>
            </c:forEach>
        </ul>
    </div>
    <div class="page">
        <span class="pagecount">共有<span id="count">${pageSupportAdmin.totalPage}</span>页</span><a href="javascript:void(0);" id="shouye" class="apage">首页</a><a href="javascript:void(0);" id="sy" class="apage">上一页</a><span class="current">当前第</span><span id="currentPage">${pageSupportAdmin.currentPage}</span><span class="current">页</span><a href="javascript:void(0);" id="xy" class="apage1">下一页</a><a href="javascript:void(0);" id="moye" class="apage">末页</a>
    </div>
</div>
<div class="pageno">
