...
<head lang="en">
    <meta charset="UTF-8">
    <title>后台管理系统--最新资讯审核</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath }/statics/css/backnews.css"/>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/jquery-1.12.4.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/backnews.js"></script>
</head>
<body>
<div class="header">
...
<div class="middle">
    <div class="middle0">
        <input class="fb" type="button" id="all" value="所有资讯"/><input class="fb" id="audit" type="button" value="待审核"/>
    </div>
    <div class="middle1">
        ...
        <p class="pcount">共<span id="totalCount">${pageSupport.totalCount}</span>个最新资讯</p>
    ...
    <div class="middle2">
        <ul class="uul">
            ...
            <c:forEach var="news" items="${pageSupport.list}">
                <li><a class="cona" href="${pageContext.request.contextPath}/backnewslook.do?id=${news.id}&pageIndex=${pageSupport.currentPage}">${news.title}</a><span class="spanftr">${news.statusName}</span><span class="spantime">${news.date}</span><a class="spancount" href="${pageContext.request.contextPath}/backnewslook.do?id=${news.id}&pageIndex=${pageSupport.currentPage}">查看</a><a class="spancount1" href="" onclick="del(${news.id})">删除</a></li>
            </c:forEach>
        </ul>
    </div>
    <div class="page">
