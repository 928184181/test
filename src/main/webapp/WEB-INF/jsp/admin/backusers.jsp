...
<head lang="en">
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath }/statics/css/backusers.css"/>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/jquery-1.12.4.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath }/statics/js/backusers.js"></script>
</head>
<body>
<div class="header">
...
<div class="header2">
    <a class="nav" href="${pageContext.request.contextPath}/toAdmin.do">最新活动审核</a><a class="nav" href="${pageContext.request.contextPath}/tobacknews.do">最新资讯审核</a><a class="nav" href="${pageContext.request.contextPath}/tobacklost.do">失物招领审核</a><a class="nav" href="${pageContext.request.contextPath}/tobackjob.do">兼职信息审核</a><a class="nav" href="${pageContext.request.contextPath}/tobackgoods.do">二手商品审核</a><a class="nav0" href="${pageContext.request.contextPath}/tobackusers.do">用户管理</a>
</div>
<div class="middle">
    <div class="middle1">
        ...
        <p class="pcount">共<span id="totalCount">${pageSupport.totalCount}</span>个用户</p>
    ...
    <div class="middle2">
        <ul class="uul">
            <li><span class="cona0">账号</span><span class="cona0">用户名</span><span class="spantime0">校区</span><span class="spantime0">注册时间</span><span class="spancount0">操作</span></li>
            <c:forEach var="users" items="${pageSupport.list}">
            <li><a class="cona" href="${pageContext.request.contextPath }/backuserslook.do?id=${users.id}&pageIndex=${pageSupport.currentPage}">${users.userCode}</a><a class="cona" href="">${users.userName}</a><span class="spantime">${users.schoolName}</span><span class="spantime">${users.date}</span><a class="spancount" href="${pageContext.request.contextPath }/backuserslook.do?id=${users.id}&pageIndex=${pageSupport.currentPage}">查看</a><a class="spancount1" href="" onclick="del(${news.id})">删除</a></li>
            </c:forEach>
        </ul>
    </div>
    <div class="page">
